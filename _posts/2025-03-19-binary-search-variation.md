...
>
> A rotated sorted list is the sorted list by rotating towards `k` steps (k >= 0). <br>
> `[4,5,1,2,3]` is a rotated sorted list. We are able to get this rotated sorted list by rotating `2` steps for `[1,2,3,4,5]`.
...
The Swift code implementation as follow:
